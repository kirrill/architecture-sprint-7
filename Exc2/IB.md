...
| 8   | Используются ли системы аутентификации пользователей для доступа к системам?                                                             |?      |Для внешних пользователей механизмы аутентификации предусмотрены, для внутренних пользователей - неизвестно|
